...
<html lang="en">
  <head>
    ...
    <title>Reservasi Gedung Abral | Admin - Login</title>
...
<main class="form-signin w-100 m-auto">
  <form action="{{route('login-proses')}}" method="post">    
    ...
    <p class="mt-5 mb-3 text-muted">&copy; Gedung Abral</p>
    <div class="col-12">
      <p class="small mb-0">Belum mempunyai akun? <a href="/register">Register</a></p>
    </div>
  </form>
</main>
